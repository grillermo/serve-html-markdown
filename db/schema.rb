...
ActiveRecord::Schema[8.1].define(version: 2026_08_20_120100) do
  ...
  create_table "scroll_positions", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["user_id", "file_name"], name: "index_scroll_positions_on_user_id_and_file_name", unique: true
    t.index ["user_id"], name: "index_scroll_positions_on_user_id"
  end

  create_table "served_files", force: :cascade do |t|
    t.datetime "created_at", null: false
  ...
  create_table "twitter_videos", force: :cascade do |t|
    ...
    t.index ["source_url"], name: "index_twitter_videos_on_source_url"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "expansion_mode", default: "create_new", null: false
